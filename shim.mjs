...
${name === 'codex' ? `CODEX_SWITCHER_ARGS=()
...
if [ -n "\${LLM_SWITCHER_CODEX_MAIN_MODEL:-}" ]; then
  CODEX_SWITCHER_ARGS+=(--config 'model="main"')
fi
if [ -n "\${LLM_SWITCHER_CODEX_REVIEW_MODEL:-}" ]; then
  CODEX_SWITCHER_ARGS+=(--config 'review_model="review"')
fi
if [ -n "\${LLM_SWITCHER_CODEX_SUBAGENT_MODEL:-}" ]; then
  CODEX_SWITCHER_ARGS+=(--config 'agents.default_subagent_model="subagent"')
fi
...
${name === 'codex' ? `set "CODEX_SWITCHER_ARGS="
...
if defined LLM_SWITCHER_CODEX_MAIN_MODEL set "CODEX_SWITCHER_ARGS=%CODEX_SWITCHER_ARGS% --config model=main"
if defined LLM_SWITCHER_CODEX_REVIEW_MODEL set "CODEX_SWITCHER_ARGS=%CODEX_SWITCHER_ARGS% --config review_model=review"
if defined LLM_SWITCHER_CODEX_SUBAGENT_MODEL set "CODEX_SWITCHER_ARGS=%CODEX_SWITCHER_ARGS% --config agents.default_subagent_model=subagent"
